...
then
	...
	if [ "$CHCHUN" = "y" ]
	then
		echo -e "Ok, uninstalling everything that has to do with hkit on your system"
		sleep 4
		rm -r /bin/hkit
		echo -e "Done."
		sleep 1
		echo -e "You need to manually delete the hkit folder from your /root/ directory though..."
		sleep 2
